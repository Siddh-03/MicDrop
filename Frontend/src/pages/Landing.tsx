        ...
        <main className="relative z-10 max-w-6xl mx-auto px-6 py-12">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-primary-foreground/80 mb-12 max-w-3xl mx-auto">
              Real-time feedback tool for speakers. Get honest, anonymous
              feedback to improve your presentations and save everyone's time.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            <Card className="bg-card/10 backdrop-blur-md border-primary-foreground/20 hover:bg-card/15 transition-all duration-300 hover:scale-105 hover:shadow-glow">
              <CardHeader className="text-center pb-4">
                ...
                <CardTitle className="text-2xl text-primary-foreground mb-2 [text-shadow:0_1px_3px_rgb(0_0_0_/_0.2)]">
                  For Speakers & Organizers
                </CardTitle>
                <CardDescription className="text-primary-foreground/80 text-base [text-shadow:0_1px_3px_rgb(0_0_0_/_0.2)]">
                  Create sessions, track engagement, and get real-time feedback
            ...
            <Card className="bg-card/10 backdrop-blur-md border-primary-foreground/20 hover:bg-card/15 transition-all duration-300 hover:scale-105 hover:shadow-glow">
              <CardHeader className="text-center pb-4">
                ...
                <CardDescription className="text-primary-foreground/80 text-base [text-shadow:0_1px_3px_rgb(0_0_0_/_0.2)]">
                  Join live sessions and provide anonymous feedback to help
                  speakers improve
                </CardDescription>
              </CardHeader>
              <CardContent className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <p className="text-primary-foreground/80">
                  Speakers set up a session with a grace period and get a unique
                  code
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-primary-foreground/80">
                  Audience members join anonymously and vote "Engaged" or
                  "Losing Me"
                </p>
              </div>
              <div className="text-center">
                ...
                <p className="text-primary-foreground/80">
                  Speakers get real-time feedback and alerts when engagement
                  drops
                </p>
              </div>
            </div>
